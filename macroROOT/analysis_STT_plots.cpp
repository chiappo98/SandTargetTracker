...
// large Scintillator layer
TH2F hAllTracks_4("hAllTracks_4", "hAllTracks_4", nBinsX, 0, 50, nBinsY, 0, 50);
// small scintillator layer
TH2F hAllTracks_5("hAllTracks_5", "hAllTracks_5", nBinsX, 0, 50, nBinsY, 0, 50);


// Digitizer V1751 (2)
TH2F hEffDC_D2_ch0("hEffDC_D2_ch0", "hEffDC_D2_ch0", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffDC_D2_ch1("hEffDC_D2_ch1", "hEffDC_D2_ch1", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffDC_D2_ch2("hEffDC_D2_ch2", "hEffDC_D2_ch2", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffDC_D2_ch3("hEffDC_D2_ch3", "hEffDC_D2_ch3", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffDC_D2_ch4("hEffDC_D2_ch4", "hEffDC_D2_ch4", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffDC_D2_ch5("hEffDC_D2_ch5", "hEffDC_D2_ch5", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D2_ch7("hEffPM_D2_ch7", "hEffPM_D2_ch7", nBinsX, 0, 50, nBinsY, 0, 50);

// Digitizer V1751 (1)
TH2F hEffPM_D1_ch0("hEffPM_D1_ch0", "hEffPM_D1_ch0", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch1("hEffPM_D1_ch1", "hEffPM_D1_ch1", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch2("hEffPM_D1_ch2", "hEffPM_D1_ch2", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch3("hEffPM_D1_ch3", "hEffPM_D1_ch3", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch4("hEffPM_D1_ch4", "hEffPM_D1_ch4", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch5("hEffPM_D1_ch5", "hEffPM_D1_ch5", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch6("hEffPM_D1_ch6", "hEffPM_D1_ch6", nBinsX, 0, 50, nBinsY, 0, 50);
TH2F hEffPM_D1_ch7("hEffPM_D1_ch7", "hEffPM_D1_ch7", nBinsX, 0, 50, nBinsY, 0, 50);
...
int anaysis(std::string inputFileROOT, std::string outputFileROOT) {
  ...
  double dc0_pp, dc1_pp, dc2_pp, dc3_pp, dc4_pp, dc5_pp;  // pulse amplitude
  double dc0_c, dc1_c, dc2_c, dc3_c, dc4_c, dc5_c; // pulse integral
  double dc0_t10, dc1_t10, dc2_t10, dc3_t10, dc4_t10, dc5_t10; // pulse time at 10% amplitude
  double pm7_pp, pm7_c, pm7_t10; // PMT info (small scintillator)
      
  // Drift Chamber Info digitizer V1751 (1)
  double dc0_1_pp, dc1_1_pp, dc2_1_pp, dc3_1_pp, dc4_1_pp, dc5_1_pp;  // pulse amplitude
  double dc0_1_c, dc1_1_c, dc2_1_c, dc3_1_c, dc4_1_c, dc5_1_c; // pulse integral
  double dc0_1_t10, dc1_1_t10, dc2_1_t10, dc3_1_t10, dc4_1_t10, dc5_1_t10; // pulse time at 10% amplitude
  ...
  if (!tree)
  {
     std::cerr << "TTree tree not available in file " << inputFileROOT << std::endl; 
     return -1;
  }
